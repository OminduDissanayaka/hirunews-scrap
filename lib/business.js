...
/**
 * Business section extractor — retrieves the leading business article and
...
/**
 * Extract business article details from a listing selector.
...
async function extractNewsData(urlSelector) {
    try {
        const baseUrl = 'https://www.hirunews.lk/business/';
        ...
        logError(error, 'business.extractNewsData');
        throw error;
    }
}
/**
 * Public: get the latest business article.
